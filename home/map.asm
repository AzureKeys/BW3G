...
.DriftveilExtra
	...
	ld a, BANK(wDecompressScratch)
	ldh [rSVBK], a
	ld hl, TilesetDriftveilExtraGFX
	ld a, BANK(TilesetDriftveilExtraGFX)
	jr .LoadExtra
...
.MistraltonExtra
	...
	ld a, BANK(wDecompressScratch)
	ldh [rSVBK], a
	ld hl, TilesetMistraltonExtraGFX
	ld a, BANK(TilesetMistraltonExtraGFX)
	jr .LoadExtra
