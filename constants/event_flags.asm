...
; Gentleman
	...
	const EVENT_BEAT_COOLTRAINERF_GIANT_CHASM
...
; GruntF
	...
	const EVENT_BEAT_COOLTRAINERM_MISTRALTON_CAVE
	const EVENT_BEAT_COOLTRAINERF_MISTRALTON_CAVE
; Lass
	...
	const EVENT_BEAT_PSYCHIC_DREAMYARD_1
	const EVENT_BEAT_PSYCHIC_DREAMYARD_2
