...
; ???
	...
	const EVENT_DRAGONSPIRAL_TOWER_2F_GIALLO
	const EVENT_DRAGONSPIRAL_TOWER_3F_RYOKU
	const EVENT_DRAGONSPIRAL_TOWER_4F_BRONIUM
	const EVENT_DRAGONSPIRAL_TOWER_5F_GORM
