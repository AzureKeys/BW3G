...
; SCHOOL_KIDM
	...
	const EVENT_BEAT_SCHOOL_KIDM_R1
; Picnicker
	const EVENT_BEAT_SCHOOL_KIDF_R1
...
; Lass
	...
	const EVENT_BEAT_PICNICKER_MOOR_OF_ICIRRUS
	const EVENT_BEAT_CAMPER_MOOR_OF_ICIRRUS
	...
	const EVENT_BEAT_COOLTRAINERF_NACRENE_OUTSKIRT
; Hiker
