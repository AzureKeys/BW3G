; Tilesets indexes (see data/tilesets.asm)
	...
	const TILESET_JOHTO_DESERT
	const TILESET_BRIDGE
	const TILESET_JOHTO_AIRPORT
	const TILESET_JOHTO_BEACH
	const TILESET_JOHTO_EAST
	const TILESET_JOHTO_MODERN_EAST
	const TILESET_NACRENE
	const TILESET_JOHTO_WEST
