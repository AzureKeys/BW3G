...
CasteliaSewers_MapEvents:
	...
	object_event 15,  1, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, CasteliaSewersTMToxic, EVENT_CASTELIA_SEWERS_TM_TOXIC
