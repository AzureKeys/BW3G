...
LentimasTown_MapEvents:
	...
	db 2 ; bg events
	bg_event 14, 12, BGEVENT_READ, LentimasAirportSign
	bg_event 33, 14, BGEVENT_READ, LentimasTownSign

	db 6 ; object events
	object_event 31,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, LentimasTownFireStone, EVENT_LENTIMAS_TOWN_FIRE_STONE
	object_event  9, 19, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, LentimasTownTMFlashCannon, EVENT_LENTIMAS_TOWN_TM_FLASH_CANNON
	object_event 11, 14, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, LentimasTownGuardScript, -1
	object_event 25, 14, SPRITE_GRANNY, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LentimasTownGrannyTextScript, -1
	object_event 17, 17, SPRITE_GRAMPS, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LentimasTownGrampsTextScript, -1
	object_event 15,  6, SPRITE_POKEFAN_F, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LentimasTownPokefanFTextScript, -1
