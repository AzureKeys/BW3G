...
FloccesyTown_MapEvents:
	...
	db 6 ; object events
	object_event 21, 16, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, FloccesyTownMoonStone, EVENT_FLOCCESY_TOWN_MOON_STONE
