...
Rt7North_MapEvents:
	...
	db 2 ; warp events
	warp_event  5, 39, R_7_TRADE_HOUSE, 1
	warp_event 15,  5, TWIST_MOUNTAIN_ENTRANCE, 1

	db 0 ; coord events

	db 2 ; bg events
	bg_event 21, 13, BGEVENT_READ, R7NorthSign
	bg_event 10, 36, BGEVENT_ITEM, R7NorthRareCandy

	db 9 ; object events
	object_event -1, 36, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, 0, EVENT_R_7_PP_UP
	object_event 25, 14, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, R7NorthShellStone, EVENT_R_7_SHELL_STONE
	object_event 14, 19, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, R7NorthHeatRock, EVENT_R_7_HEAT_ROCK
	object_event 29, 44, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, R7NorthTMXScissor, EVENT_R_7_TM_X_SCISSOR
