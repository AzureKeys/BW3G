...
Rt13_MapEvents:
	...
	object_event  5, 12, SPRITE_PATRAT_SIDE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, R13Blocker2TextScript, EVENT_R13_BLOCKER
	object_event  6, 12, SPRITE_PURRLOIN_SIDE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, R13Blocker3TextScript, EVENT_R13_BLOCKER
	object_event  7, 12, SPRITE_LASS, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, R13Blocker4TextScript, EVENT_R13_BLOCKER
	...
	object_event 15, 39, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 2, TrainerSchoolKidMR13, -1
