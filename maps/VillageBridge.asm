...
VillageBridge_MapEvents:
	...
	object_event 11,  6, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_ROCK, OBJECTTYPE_TRAINER, 3, TrainerHoopster1VillageBridge, -1
	object_event 15,  7, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_ROCK, OBJECTTYPE_TRAINER, 2, TrainerHoopster2VillageBridge, -1
