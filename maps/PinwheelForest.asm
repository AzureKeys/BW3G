...
PinwheelForest_MapEvents:
	...
	object_event 23, 29, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, PinwheelForestBigRoot, EVENT_PINWHEEL_FOREST_BIG_ROOT
	...
	object_event 21, 23, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, PinwheelForestShellStone, EVENT_PINWHEEL_FOREST_SHELL_STONE
