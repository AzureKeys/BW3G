	...
	const RELICPASSAGEBACK_BIG_PEARL
...
RelicPassageBack_MapEvents:
	...
	object_event 11, 21, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RelicPassageBigPearl, EVENT_RELIC_PASSAGE_BIG_PEARL
