	...
	const OPELUCIDPOKECENTER_COOLTRAINER_M
...
OpelucidPokecenterCooltrainerMText:
...
OpelucidPokecenter1F_MapEvents:
	...
	object_event  8,  5, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_BLUE_D, OBJECTTYPE_SCRIPT, 0, OpelucidPokecenterCooltrainerMScript, -1
