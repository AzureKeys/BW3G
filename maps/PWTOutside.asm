...
PWTOutside_MapEvents:
	...
	object_event 20, 25, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, PwtOutsideFocusSash, EVENT_PWT_OUTSIDE_FOCUS_SASH
