	...
	const CHARGESTONECAVE1F_DUSK_BALL
...
ChargestoneCave1F_MapEvents:
	...
	object_event 32, 30, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, ChargestoneDuskBall, EVENT_CHARGESTONE_DUSK_BALL
