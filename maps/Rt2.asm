...
Rt2_MapEvents:
	...
	object_event 27, 18, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, R2LoveBall, EVENT_R2_LOVE_BALL
	...
	object_event  8, 15, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, R2UltraBall, EVENT_R2_ULTRA_BALL
