...
P2Lab_MapEvents:
	...
	object_event  5, 32, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, P2LabTMSludgeBomb, EVENT_P2_LAB_TM_SLUDGE_BOMB
