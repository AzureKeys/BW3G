...
InitializeEventsScript:
	...
	setevent EVENT_STRIATON_GYM_CAMPER_1
	setevent EVENT_STRIATON_GYM_CAMPER_2
	setevent EVENT_STRIATON_GYM_PICNICKER_1
	setevent EVENT_STRIATON_GYM_PICNICKER_2
...
.Marla:
	farwritetext MarlaNumberAcceptedText
	waitbutton
	closetext
	end
...
.Marla:
	farwritetext MarlaNumberDeclinedText
	waitbutton
	closetext
	end
...
.Marla:
	farwritetext MarlaPhoneFullText
	waitbutton
	closetext
	end
