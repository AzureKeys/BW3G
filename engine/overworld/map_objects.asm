...
.ShadowObject:
	...
	db $00, PAL_OW_BROWN, SPRITEMOVEDATA_SHADOW
...
.BoulderDustObject:
	db $00, PAL_OW_BROWN, SPRITEMOVEDATA_BOULDERDUST
...
.EmoteObject:
	db $00, PAL_OW_GREEN, SPRITEMOVEDATA_EMOTE
...
.ScreenShakeObject:
	db $00, PAL_OW_BROWN, SPRITEMOVEDATA_SCREENSHAKE
