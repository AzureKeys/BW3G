...
MarketShop:
	call FarReadMart
	call LoadStandardMenuHeader
	ld hl, Text_Market_Intro
	call MartTextBox
	call BuyMenu
	ld hl, Text_Market_ComeAgain
	call MartTextBox
	ret
...
.MarketPointers:
	dw Text_Market_HowMany
	dw Text_Market_CostsThisMuch
	dw Text_Market_InsufficientFunds
	dw Text_Market_BagFull
	dw Text_Market_HereYouGo
	dw BuyMenuLoop
...
Text_Market_Intro:
	text_far Market_IntroText
	text_end
	
Text_Market_ComeAgain:
	text_far Market_ComeAgainText
	text_end
	
Text_Market_HowMany:
	text_far Market_HowManyText
	text_end
	
Text_Market_CostsThisMuch:
	text_far Market_CostsThisMuchText
	text_end
	
Text_Market_InsufficientFunds:
	text_far Market_InsufficientFundsText
	text_end
	
Text_Market_BagFull:
	text_far Market_BagFullText
	text_end
	
Text_Market_HereYouGo:
	text_far Market_HereYouGoText
	text_end
