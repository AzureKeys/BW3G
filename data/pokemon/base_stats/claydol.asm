	...
	; tm/hm learnset
	tmhm GIGA_IMPACT, CALM_MIND, TOXIC, HIDDEN_POWER, SUNNY_DAY, ICE_BEAM, HYPER_BEAM, LIGHT_SCREEN, PROTECT, RAIN_DANCE, DAZZLINGLEAM, SOLARBEAM, STONE_EDGE, EARTHQUAKE, RETURN, DIG, PSYCHIC_M, SHADOW_BALL, BULLDOZE, DOUBLE_TEAM, REFLECT, SANDSTORM, ROCK_TOMB, HEX, DREAM_EATER, REST, ATTRACT, ROCK_SLIDE, FLY, STRENGTH, IRON_DEFENSE, ZEN_HEADBUTT, SIGNAL_BEAM, EARTH_POWER
	; end
