	...
	; tm/hm learnset
	tmhm DRAGON_CLAW, ROAR, TOXIC, BULK_UP, HIDDEN_POWER, SUNNY_DAY, PROTECT, RAIN_DANCE, STONE_EDGE, RETURN, DIG, DOUBLE_TEAM, SLUDGE_BOMB, ROCK_TOMB, HEX, REST, ATTRACT, THIEF, ROCK_SLIDE, FOCUS_BLAST, STRENGTH, IRON_DEFENSE, IRON_TAIL, ZEN_HEADBUTT, FIRE_PUNCH, ICE_PUNCH, DRAGON_PULSE, DARK_PULSE, LOW_KICK, SUPER_FANG, THUNDERPUNCH, DRAIN_PUNCH
	; end
