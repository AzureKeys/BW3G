	...
	; tm/hm learnset
	tmhm GIGA_IMPACT, SWORDS_DANCE, ROAR, TOXIC, VENOSHOCK, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, PROTECT, RAIN_DANCE, EARTHQUAKE, RETURN, DIG, SHADOW_BALL, BULLDOZE, DOUBLE_TEAM, X_SCISSOR, SLUDGE_BOMB, ROCK_TOMB, REST, ATTRACT, THIEF, ROCK_SLIDE, STRUGGLE_BUG, CUT, STRENGTH, IRON_DEFENSE, IRON_TAIL, HONE_CLAWS, AQUA_TAIL, BUG_BITE, GUNK_SHOT, DARK_PULSE
	; end
