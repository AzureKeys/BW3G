...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X | X_FLIP, $a0, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_02, PAL_BATTLE_OB_GREEN, ANIM_GFX_EGG ; ANIM_OBJ_OCTAZOOKA
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_1A, BATTLEANIMFUNC_07, PAL_BATTLE_OB_BLUE, ANIM_GFX_ROCKS ; ANIM_OBJ_SMALL_ROCK
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_07, PAL_BATTLE_OB_BLUE, ANIM_GFX_ROCKS ; ANIM_OBJ_BIG_ROCK
	battleanimobj RELATIVE_X, $b4, BATTLEANIMFRAMESET_2A, BATTLEANIMFUNC_00, PAL_BATTLE_OB_RED, ANIM_GFX_WATER ; ANIM_OBJ_HYDRO_PUMP
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_14, BATTLEANIMFUNC_01, PAL_BATTLE_OB_BROWN, ANIM_GFX_ICE ; ANIM_OBJ_ICE_BEAM
	battleanimobj RELATIVE_X | X_FLIP, $00, BATTLEANIMFRAMESET_HAIL, BATTLEANIMFUNC_4A, PAL_BATTLE_OB_BLUE, ANIM_GFX_ICE ; ANIM_OBJ_HAIL
