...
; entries correspond to deco constants
	...
	decoration DECO_POSTER,  BLITZLE,        SET_UP_POSTER,     EVENT_DECO_POSTER_1,             $23
	...
	decoration DECO_BIGDOLL, KROOKODILE,        SET_UP_BIG_DOLL,   EVENT_DECO_BIG_SNORLAX_DOLL,     SPRITE_BIG_SNORLAX
	decoration DECO_BIGDOLL, ONIX,           SET_UP_BIG_DOLL,   EVENT_DECO_BIG_ONIX_DOLL,        SPRITE_BIG_ONIX
	decoration DECO_BIGDOLL, BASCULIN,         SET_UP_BIG_DOLL,   EVENT_DECO_BIG_LAPRAS_DOLL,      SPRITE_BIG_LAPRAS
	decoration DECO_PLANT,   PUT_IT_AWAY,    PUT_AWAY_DOLL,     EVENT_TEMPORARY_UNTIL_MAP_RELOAD_1,       $00
	decoration DECO_DOLL,    BLITZLE,        SET_UP_DOLL,       EVENT_DECO_PIKACHU_DOLL,         SPRITE_SNEASEL
	decoration DECO_PLANT,   SURF_PIKA_DOLL, SET_UP_DOLL,       EVENT_DECO_SURFING_PIKACHU_DOLL, SPRITE_SURFING_PIKACHU
	decoration DECO_DOLL,    CLEFAIRY,       SET_UP_DOLL,       EVENT_DECO_CLEFAIRY_DOLL,        SPRITE_SNEASEL
	decoration DECO_DOLL,    JIGGLYPUFF,     SET_UP_DOLL,       EVENT_DECO_JIGGLYPUFF_DOLL,      SPRITE_JIGGLYPUFF
	decoration DECO_DOLL,    SNIVY,      SET_UP_DOLL,       EVENT_DECO_BULBASAUR_DOLL,       SPRITE_SNEASEL
	decoration DECO_DOLL,    TEPIG,     SET_UP_DOLL,       EVENT_DECO_CHARMANDER_DOLL,      SPRITE_SNEASEL
	decoration DECO_DOLL,    OSHAWOTT,       SET_UP_DOLL,       EVENT_DECO_SQUIRTLE_DOLL,        SPRITE_SNEASEL
	decoration DECO_DOLL,    TYMPOLE,        SET_UP_DOLL,       EVENT_DECO_POLIWAG_DOLL,         SPRITE_SNEASEL
	decoration DECO_DOLL,    DRILBUR,        SET_UP_DOLL,       EVENT_DECO_DIGLETT_DOLL,         SPRITE_SNEASEL
	decoration DECO_DOLL,    STARYU,         SET_UP_DOLL,       EVENT_DECO_STARMIE_DOLL,         SPRITE_SNEASEL
	decoration DECO_DOLL,    TYNAMO,       SET_UP_DOLL,       EVENT_DECO_MAGIKARP_DOLL,        SPRITE_SNEASEL
	decoration DECO_DOLL,    PETILIL,         SET_UP_DOLL,       EVENT_DECO_ODDISH_DOLL,          SPRITE_SNEASEL
	decoration DECO_DOLL,    GENGAR,         SET_UP_DOLL,       EVENT_DECO_GENGAR_DOLL,          SPRITE_SNEASEL
	decoration DECO_DOLL,    CORPHISH,       SET_UP_DOLL,       EVENT_DECO_SHELLDER_DOLL,        SPRITE_SNEASEL
	decoration DECO_DOLL,    TRUBBISH,         SET_UP_DOLL,       EVENT_DECO_GRIMER_DOLL,          SPRITE_SNEASEL
	decoration DECO_DOLL,    MAGNEMITE,        SET_UP_DOLL,       EVENT_DECO_VOLTORB_DOLL,         SPRITE_SNEASEL
	decoration DECO_DOLL,    VENIPEDE,         SET_UP_DOLL,       EVENT_DECO_WEEDLE_DOLL,          SPRITE_SNEASEL
	decoration DECO_DOLL,    BALTOY,          SET_UP_DOLL,       EVENT_DECO_UNOWN_DOLL,           SPRITE_SNEASEL
	decoration DECO_DOLL,    ROGGENROLA,        SET_UP_DOLL,       EVENT_DECO_GEODUDE_DOLL,         SPRITE_SNEASEL
	decoration DECO_DOLL,    TIMBURR,         SET_UP_DOLL,       EVENT_DECO_MACHOP_DOLL,          SPRITE_SNEASEL
	decoration DECO_DOLL,    FRILLISH,      SET_UP_DOLL,       EVENT_DECO_TENTACOOL_DOLL,       SPRITE_SNEASEL
