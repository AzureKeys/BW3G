...
; entries correspond to trainer classes (see constants/trainer_constants.asm)
	...
	db MUSIC_YOUNGSTER_ENCOUNTER   ; n
	db MUSIC_YOUNGSTER_ENCOUNTER   ; hilbert
	db MUSIC_YOUNGSTER_ENCOUNTER   ; hilda
	db MUSIC_YOUNGSTER_ENCOUNTER   ; nate
	db MUSIC_YOUNGSTER_ENCOUNTER   ; rosa
