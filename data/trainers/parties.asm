...
DraydenGroup:
	; DRAYDEN (1)
	db "DRAYDEN@", TRAINERTYPE_MOVES
	db 15, GASTLY, HYPNOSIS, CURSE, NIGHT_SHADE, HEX
	db 14, LITWICK, FIRE_SPIN, CONFUSE_RAY, WILL_O_WISP, HEX
	db 18, SPIRITOMB, SHADOW_SNEAK, FAINT_ATTACK, HYPNOSIS, HEX
	db -1 ; end
