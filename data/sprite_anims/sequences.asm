...
; entries correspond to SPRITE_ANIM_INDEX_* constants
	...
	db SPRITE_ANIM_FRAMESET_MAGNET_TRAIN_BLUE_D,      SPRITE_ANIM_SEQ_NULL,                    $00 ; SPRITE_ANIM_INDEX_MAGNET_TRAIN_RED
	...
	db SPRITE_ANIM_FRAMESET_RED_D_WALK,               SPRITE_ANIM_SEQ_NULL,                    $00 ; SPRITE_ANIM_INDEX_BLUE_WALK
	db SPRITE_ANIM_FRAMESET_MAGNET_TRAIN_RED_D,       SPRITE_ANIM_SEQ_NULL,                    $00 ; SPRITE_ANIM_INDEX_MAGNET_TRAIN_BLUE
	...
	db SPRITE_ANIM_FRAMESET_BLUE_D_WALK,              SPRITE_ANIM_SEQ_NULL,                    $00 ; SPRITE_ANIM_INDEX_BLUE_WALK
