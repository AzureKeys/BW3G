...
MapGroup_Castelia:
	...
	map CasteliaDeptStore1F, TILESET_MART, INDOOR, CASTELIA_CITY, MUSIC_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CasteliaDeptStore2F, TILESET_MART, INDOOR, CASTELIA_CITY, MUSIC_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CasteliaDeptStore3F, TILESET_MART, INDOOR, CASTELIA_CITY, MUSIC_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CasteliaDeptStore4F, TILESET_MART, INDOOR, CASTELIA_CITY, MUSIC_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CasteliaDeptStoreElevator, TILESET_MART, INDOOR, CASTELIA_CITY, MUSIC_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
