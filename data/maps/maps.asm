...
MapGroup_Dungeons:
	...
	map TwistMountainEntrance, TILESET_CAVE, CAVE, TWIST_MOUNTAIN, MUSIC_UNOVA_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map TwistMountain1F, TILESET_CAVE, CAVE, TWIST_MOUNTAIN, MUSIC_UNOVA_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map TwistMountain2F, TILESET_CAVE, CAVE, TWIST_MOUNTAIN, MUSIC_UNOVA_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map TwistMountain3F, TILESET_CAVE, CAVE, TWIST_MOUNTAIN, MUSIC_UNOVA_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map TwistMountainOutside, TILESET_CAVE_RUINS, ROUTE, TWIST_MOUNTAIN, MUSIC_UNOVA_CAVE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map TwistMountainHouse, TILESET_HOUSE, INDOOR, TWIST_MOUNTAIN, MUSIC_UNOVA_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map TwistMountainB1F, TILESET_CAVE, CAVE, TWIST_MOUNTAIN, MUSIC_UNOVA_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map TwistMountainGenesectRoom, TILESET_CAVE, CAVE, TWIST_MOUNTAIN, MUSIC_UNOVA_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_PkmnLeague:
	...
	map HallOfFame, TILESET_CHAMPIONS_ROOM, INDOOR, POKEMON_LEAGUE, MUSIC_NUVEMA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
